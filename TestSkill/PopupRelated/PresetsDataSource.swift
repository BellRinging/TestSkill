...
struct PresetsDataSource {
    ...
    private mutating func setupToastPresets() {
        ...
        attributes.entryBackground = .color(color: ColorEK.LightBlue.a700)
        attributes.entranceAnimation = .init(
    ...
    private mutating func setupNotePresets() {
        ...
        attributes.popBehavior = .animated(animation: .translation)
        attributes.entryBackground = .color(color: ColorEK.Purple.deep)
        attributes.statusBar = .light
        ...
        attributes.entryBackground = .gradient(
            gradient: .init(
                colors: [ColorEK.Purple.a300, ColorEK.Purple.a400, ColorEK.Purple.a700],
                startPoint: .zero,
    ...
    private mutating func setupFloatPresets() {
        ...
        attributes.entryBackground = .gradient(
            gradient: .init(
                colors: [ColorEK.BlueGradient.dark, ColorEK.BlueGradient.light],
                startPoint: .zero,
                endPoint: CGPoint(x: 1, y: 1)
            )
        )
    ...
    private mutating func setupPopupPresets() {
        ...
        attributes.entryBackground = .gradient(
            gradient: .init(
                colors: [ColorEK.LightPink.first, ColorEK.LightPink.last],
                startPoint: .zero,
                endPoint: CGPoint(x: 1, y: 1)
            )
        )
    ...
    private mutating func setupFormPresets() {
        ...
        attributes.entryBackground = .gradient(
            gradient: .init(
                colors: [ColorEK.Netflix.light, ColorEK.Netflix.dark],
                startPoint: .zero,
                endPoint: CGPoint(x: 1, y: 1)
            )
        )
