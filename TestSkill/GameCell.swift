...
//            image.loadImage(url)
    ...
    func setupView(){
        ...
        gameDateLabel.Anchor(top: topAnchor, left: leftAnchor, right: nil, bottom: nil, topPadding: 0, leftPadding: 0, rightPadding: 0, bottomPadding: 0, width: self.frame.width, height: 0)
