...
class DisplayPhotoView: UIViewController {
    ...
    func setupViewlayout(){
        ...
        cancelButton.Anchor(top: view.topAnchor, left: view.leftAnchor, right: nil, bottom: nil, topPadding: 20, leftPadding: 8, rightPadding: 0, bottomPadding: 0, width: 20, height: 20)
    }
